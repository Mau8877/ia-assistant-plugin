...
Esta fase prepara la arquitectura base para generar unidades educativas con IA, sin conectar todavía la UI, sin crear handler XBlock y sin hacer llamadas externas reales.
...
- API frontend para IA.
- Panel/botón de IA en Studio.
...
4. Implementar panel/botón en Studio.
