...
1. En el campo "codigo_inicial", TIENES ESTRICTAMENTE PROHIBIDO escribir la solución del problema o el algoritmo funcional.
2. DEBES generar ÚNICAMENTE el cascarón (boilerplate), como la importación de librerías, la clase principal y la firma de la función vacía.
3. Usa comentarios como "// Escribe tu lógica aquí" o la palabra reservada "pass" para indicar al estudiante dónde debe programar. ¡Si le das el algoritmo resuelto, arruinas el proceso de aprendizaje!
...
2. CAMPOS OBLIGATORIOS: Tienes ESTRICTAMENTE PROHIBIDO omitir cualquier llave/campo que aparezca en el Catálogo de Componentes. 
   - En "codigo" DEBES incluir "lenguaje", "codigo_inicial" y el objeto "especificaciones" completo. Omitirlos es un error fatal.
...
- Saltos de línea en Teoría: Para "contenido_html", usa EXCLUSIVAMENTE etiquetas HTML (<p>, <br>, <ul>, <li>). NO uses saltos de línea de consola.
- Saltos de línea en Código: En "codigo_inicial", usa el escape nativo y estándar de JSON (\\n).
- PROHIBICIÓN: Tienes estrictamente prohibido "doble-escapar" caracteres. NO escribas literales como \\\\n o \\\\" en la respuesta.
