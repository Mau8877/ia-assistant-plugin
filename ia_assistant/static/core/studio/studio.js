function STUDIO_DOCENTE_INIT(runtime, element) {
    ...
    // 2. Instanciación del Módulo Editor (Llamando al Namespace)
    var EDITOR = new window.IA_Components.EDITOR_UNIDAD(element, HANDLER_GUARDAR_UNIDAD);

    // 3. Instanciación del Módulo Generador (Llamando al Namespace)
    var GENERADOR = new window.IA_Components.GENERADOR_UNIDAD(element, HANDLER_LLAMAR_IA, {
        onStart: function () {
